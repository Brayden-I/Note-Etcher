...
if(element == null) throw new System.InvalidOperationException("Could not find an element named Createmode - did you forget to load a Gum project?");
    ...
    public ButtonStandardIcon EditButton { get; protected set; }
    public ButtonIcon TrashButton { get; protected set; }
    ...
    protected override void ReactToVisualChanged()
    {
        ...
        EditButton = global::Gum.Forms.GraphicalUiElementFormsExtensions.TryGetFrameworkElementByName<ButtonStandardIcon>(this.Visual,"EditButton");
        TrashButton = global::Gum.Forms.GraphicalUiElementFormsExtensions.TryGetFrameworkElementByName<ButtonIcon>(this.Visual,"TrashButton");
